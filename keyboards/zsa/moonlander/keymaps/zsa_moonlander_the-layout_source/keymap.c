...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    MO(2),          KC_TRANSPARENT, OSM(MOD_LALT), KC_TRANSPARENT, KC_TRANSPARENT,  KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,  KC_TRANSPARENT, OSM(MOD_RALT),  KC_TRANSPARENT, KC_TRANSPARENT,
    ...
    OSL(1),         OSM(MOD_LGUI),  KC_TRANSPARENT,                 KC_TRANSPARENT, OSM(MOD_RGUI),  OSL(1)
  ),
