...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    MO(2),          KC_TRANSPARENT, OSM(MOD_LALT), LCTL(KC_A),  OSL(3),          KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, OSL(3),          OSM(MOD_LGUI),  OSM(MOD_RALT),  KC_TRANSPARENT, KC_TRANSPARENT,
