...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, OSM(MOD_RCTL), LCTL(KC_A),  OSL(3),          KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, OSL(3),          OSM(MOD_LGUI),  OSM(MOD_RCTL),  KC_TRANSPARENT, KC_TRANSPARENT,
  ...
  [1] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, OSM(MOD_RCTL), KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, OSM(MOD_RCTL),  KC_TRANSPARENT, KC_TRANSPARENT,
