...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, LCTL(KC_A), OSM(MOD_RCTL),  OSL(3),          KC_TRANSPARENT, KC_TRANSPARENT,                                 KC_TRANSPARENT, KC_TRANSPARENT, OSL(3),          OSM(MOD_RCTL),  OSM(MOD_LGUI),  KC_TRANSPARENT, KC_TRANSPARENT,
