...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, OSM(MOD_RCTL),  KC_BRIU,        KC_BRID,        LCTL(LGUI(KC_T)),                               KC_MUTE,        KC_VOLD,        KC_VOLU,        OSM(MOD_RCTL),  KC_TRANSPARENT, KC_TRANSPARENT, LCTL(LGUI(KC_Q)),
